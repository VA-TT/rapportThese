...
\begin{frame}{Influnce du terme dynamique ($\sigma_3 = 30 \times 10^3$)}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \scalebox{0.5}{\input{3000KineticComp.tex}}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \scalebox{0.5}{\input{3000SansKineticComp.tex}}
...
\begin{frame}{1000 particules}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \scalebox{0.4}{\input{Cercle_1000_residuel.tex}}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \scalebox{0.5}{\input{1000_mu_I_fit.tex}}
...
%             \begin{figure}[h]
%                 \centering
%                 \scalebox{0.4}{\input{epsyy_epsv.tex}}
%                 \caption{Cercles de Mohr}
%             \end{figure}
%         \end{column}
%         \begin{column}{0.5\textwidth}
