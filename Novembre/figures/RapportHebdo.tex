...
\begin{frame}{État Rankine}
    ...
    \begin{table}
        ...
        \begin{tabular}{|c|l|l|}
            ...
            $\varphi$ & Angle de frottement  & $25^{\circ}$\\
            $\psi$ & Angle de dilatance  & $\approx 0^{\circ}$\\
            $v$ & Vélocité de déplacement & 0.005 m/s\\
            $c$ & Cohésion & 0 \& 100 Pa\\
            \hline
        \end{tabular}
        \caption{Paramètres du modèle Mohr-Coulomb}
    \end{table}
\end{frame}
...
\begin{frame}{État Rankine}
    \begin{multicols}{2}
            \begin{figure}
                \centering
                  \scalebox{0.45}{\input{Actif.tex}}
                \caption{Pression actif}
            \end{figure}      
            \columnbreak  
            \begin{figure}
                \centering
                \scalebox{0.45}{\input{Passif.tex}}
                \caption{Pression passif}
            \end{figure}
        \end{multicols}
        \end{frame}
