...
sigma1_1 = 54.3984 #Compression residuel
...
plot y_tangent_common2(x) with lines lc rgb colors[2] title sprintf('$I = 10^{-3}: \varphi = %.2f^{\circ}, c = %.2f$ kPa', phi_common_degree2, c_common2),\
