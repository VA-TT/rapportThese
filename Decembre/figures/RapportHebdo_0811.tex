    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{figure}
                ...
                \caption{Nombre de NombreCoordination}
            \end{figure}
            hpd: $\varepsilon_{yy} = \dfrac{\Delta {yy}}{h_{yy}^0}; \varepsilon_v = \varepsilon_{xx} + \varepsilon_{yy} + \varepsilon_{zz} $
        \end{column}
                \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
            ...
            \end{figure}
            gd: $\varepsilon_{yy} = \ln(\dfrac{h_{yy}}{h_{yy}^0});  \varepsilon_v = \dfrac{\Delta V}{V_0}$;
        \end{column}
    \end{columns}
