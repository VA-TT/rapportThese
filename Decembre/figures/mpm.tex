...
\begin{frame}{Stabilisation - Théorie élastique vs Rankine}
	$E = 1e9\ Pa, \nu=0.2, \varphi=25^{\circ}, \psi=0^{\circ},c=0, PIC=99\%$
		...
		Modèle élastique: $K_0 = \dfrac{\sigma_{xx}}{sigma_{yy}} = \dfrac{\nu}{1 - \nu}$
\end{frame}
...
\begin{frame}{Stabilisation - Taux de contrainte}
		\begin{figure}
			\centering
			\scalebox{0.7}{\input{longeur.tex}}
			\caption{Longueur du modèle \\
			$\nu=0.33, E = 1e6kPa,  H = 1m, N_{\text{PM}} = 1200$}
		\end{figure}
\end{frame}

\begin{frame}{Stabilisation élastique - Taux de contrainte}
		\begin{figure}
			\centering
			\scalebox{0.7}{\input{v=0.49.tex}}
			\caption{Nombre de MPs ($\nu=0.49, E = 1e6kPa$), bande au milieu}
		\end{figure}
\end{frame}
...
\begin{frame}{Stabilisation élastique - Taux de contrainte}
	\begin{multicols}{2}
		\begin{figure}
			...
			\caption{Nombre de MPs ($\nu=0.33, E = 1e6kPa$), bande au milieu}
		\end{figure}
				\columnbreak
		\begin{figure}
			\centering
			\scalebox{0.45}{\input{mur.tex}}
			\caption{Nombre de MPs ($\nu=0.33, E = 1e6kPa$), bande au bord}		
		\end{figure}
	\end{multicols}
\end{frame}
