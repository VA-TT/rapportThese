...
\begin{frame}{État Rankine - Modèle}
	...
	\end{figure}
	Attander la stabilisation sous la gravité d'abord
\end{frame}
...
\begin{frame}{Stabilisation - Modèle avec des points fixées}
		\begin{figure}[h]
			...
			L = 3m, H = 1m, $\rho = 2700\ \mathrm{kg/m^3}, N_{\text{PM}} = 1200, dt = 1e^{-5}s$\\
			Fixer les déplacements des points latérales selon l'axe x et de celles en dessous selon l'axe y
		\end{figure}
...
\begin{frame}{Stabilisation - Taux de contrainte de bande au milieu}
		\begin{figure}
			\centering
			\scalebox{0.5}{\input{dt.tex}}
			\caption{Pas de temps}
			Modèle élastique: $\nu=0.33, E = 1e9 Pa, L=3m, H = 1m$
...
\begin{frame}{Stabilisation - Taux de contrainte de bande au milieu}
		\begin{figure}
			...
			\caption{Longueur du modèle}
						Modèle élastique: $\nu=0.33, E = 1e9 Pa,  H = 1m, dt = 1e^{-5}s$
		\end{figure}
		$$K_0 = \dfrac{\sigma_{xx}}{\sigma_{yy}} = \dfrac{\nu}{1 - \nu} == \dfrac{0.33}{1-0.33} = 0.493 $$
\end{frame}
...
\begin{frame}{Stabilisation - Taux de contrainte de bande au milieu}
		\begin{figure}
			...
			\caption{Nombre de MPs}
				Modèle élastique: $\nu=0.49, E = 1e9 Pa,  L = 3m, dt = 1e^{-5}s$
		\end{figure}
	...
	\begin{multicols}{2}
		\begin{figure}
			...
			\caption{Bande au milieu}
							Modèle élastique: $\nu=0.33, E = 1e9 Pa,  L = 3m, dt = 1e^{-5}s$
		\end{figure}
				\columnbreak
		\begin{figure}
			\centering
...
\begin{frame}{Stabilisation élastique - Lignes fixées}
		\begin{figure}[h]
			...
			\caption{Le maillage et les lignes fixées}
			L = 3m, H = 1m, $\rho = 2700\ \mathrm{kg/m^3}, N_{\text{PM}} = 1200, dt = 1e^{-5}s$\\
Interaction entre des points matériels et un mur avec la loi de contact visco-élastique frictionnelle similaire à la DEM ($ \mu_{\text{mur-PM}} = 0$)
		\end{figure}
\end{frame}
...
\begin{frame}{Stabilisation - Théorie élastique}
											Modèle élastique: $\nu=0.33, E = 1e9 Pa,  L = 3m, H = 1m, dt = 1e^{-5}s$
	\begin{align}
		\sigma_{yy} & = \rho \, g \, H = 2700 \cdot 9.81 \cdot 1 = 26487\ \text{Pa}                                                  \\[6pt]
		F_{yy}      & = \sigma_{yy} \cdot L = 26487 \cdot 3 = 79461\ \text{N}                                                        \\[6pt]
